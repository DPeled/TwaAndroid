...
public final class ActivityErrorBinding implements ViewBinding {
  ...
  private ActivityErrorBinding(@NonNull LinearLayout rootView, @NonNull TextView errorTextView,
  ...
  public static ActivityErrorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityErrorBinding((LinearLayout) rootView, errorTextView, retryButton);
    }
